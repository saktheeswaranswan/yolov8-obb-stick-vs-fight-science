# -*- coding: utf-8 -*-
"""newwerbestrstickbestyobbtrain_yolov8_obballsetand_bestobb.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1MMaMCHCVVXduaihXIGNdoBWQFTgxai79
...
model = YOLO('/content/yolov8x-obb.pt')
...
model = YOLO('/content/hfhfhf.pt')

# 2️⃣ Run OBB inference on the video
results = model.predict(
    source='/content/addddduuthuuy.mp4'  , # input video
...
!yt-dlp -f mp4 -o "/content/%(title)s.%(ext)s" "https://www.youtube.com/watch?v=MWvfp5oNF5M"

https://www.youtube.com/watch?v=-xuBuWdKOBw

https://www.youtube.com/watch?v=-xuBuWdKOBw

https://www.youtube.com/watch?v=UrbzWyM8Bps
